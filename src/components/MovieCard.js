        ...
        <div className="movies__item">
          ...
          <div className="movies__data">
            <div className="movies__description">
              <div className="movies__title" title={state.original_title}>
              ...
              <div className="movies__stats">
                ...
                <div className="movies__stats-data">
                  Popularity: <span>{state.popularity}</span>
                </div>
                ...
                <div className="movies__stats-data">
                  ...
                  >
                    {" "}
                    <span style={{ fontSize: ".7em" }}>{state.homepage} </span>
                  </a>
                </div>
              </div>
              ...
              <div className="footer">
                <p>
                  © 2020 Jer Carlo Catallo | All rights reserved | Release
                  Version 0.3{" "}
                </p>
              </div>
            </div>
